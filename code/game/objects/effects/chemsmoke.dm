...
//------------------------------------------
/datum/effect/effect/system/chem_smoke_spread/set_up(var/datum/reagents/carry = null, n = 10, c = 0, loca, direct)
	range = n * 0.3
	cardinals = c
				...
				for(var/i = 0, i < runs, i++)
					for(var/turf/T in targetTurfs)
						...
						for(var/atom/A in T.contents)
							if(istype(A, /obj/effect/effect/chem_smoke))	//skip the item if it is chem smoke
								continue
...
//------------------------------------------
/datum/effect/effect/system/chem_smoke_spread/proc/spawnSmoke(var/turf/T, var/icon/I, var/dist = 1)
	var/obj/effect/effect/chem_smoke/smoke = new(location)
	if(chemholder.reagents.reagent_list.len)
...
//------------------------------------------
/datum/effect/effect/system/chem_smoke_spread/proc/fadeOut(var/atom/A, var/frames = 16)
...
//------------------------------------------
/datum/effect/effect/system/chem_smoke_spread/proc/smokeFlow()
