...
/mob/living/carbon/proc/updateshock()
	...
	if(reagents.has_reagent("alkysine"))  // this has to be reverted to its original state as it was resulting in painkillers being ineffective for anything and everything.
